...
declare module BABYLON.GuiEditor.SharedUIComponents {
        type ToggleButtonProps = Omit<BABYLON.GuiEditor.SharedUIComponents.ButtonProps, "icon" | "onClick"> & {
        value: boolean;
        checkedIcon: any;
        uncheckedIcon?: any;
        onChange: (checked: boolean) => void;
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        export type TextInputProps = BABYLON.GuiEditor.SharedUIComponents.PrimitiveProps<string> & {
        validator?: (value: string) => boolean;
    };
...
declare module BABYLON.GuiEditor.SharedUIComponents {
    ...
    export type ImmutablePrimitiveProps<ValueT> = BasePrimitiveProps & {
         ...
         * Optional information to display as an infoLabel popup aside the component.
         */
        infoLabel?: BABYLON.GuiEditor.SharedUIComponents.InfoLabelParentProps;
    };
    export type PrimitiveProps<T> = ImmutablePrimitiveProps<T> & {
        /**
         * Called when the primitive value changes
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        export type LinkProps = BABYLON.GuiEditor.SharedUIComponents.ImmutablePrimitiveProps<string> & {
        /**
         * Used if you want to handle the link click yourself
         */
        onLink?: () => void;
...
declare module BABYLON.GuiEditor.SharedUIComponents {
    ...
    type HsvKey = "h" | "s" | "v";
    type InputHsvFieldProps = BABYLON.GuiEditor.SharedUIComponents.PrimitiveProps<Color3 | Color4> & {
        hsvKey: HsvKey;
        max: number;
        scale?: number;
    };
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        export type ButtonProps = BABYLON.GuiEditor.SharedUIComponents.BasePrimitiveProps & {
        onClick: () => void;
        icon?: any;
        appearance?: "subtle" | "transparent";
        label?: string;
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        type FileUploadLineProps = Omit<BABYLON.GuiEditor.SharedUIComponents.ButtonProps, "onClick" | "label"> & {
        onClick: (files: FileList) => void;
        label: string;
        accept: string;
    };
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        type ButtonLineProps = Omit<BABYLON.GuiEditor.SharedUIComponents.ButtonProps, "label"> & {
        label: string;
    };
    /**
     * Wraps a button with a label in a line container
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        /**
     * Wraps a link in a property line
     * @param props - BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps and BABYLON.GuiEditor.SharedUIComponents.LinkProps
     * @returns property-line wrapped link
     */
    export var LinkPropertyLine: React.FunctionComponent<BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps<string> & BABYLON.GuiEditor.SharedUIComponents.LinkProps>;
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        /**
     * Wraps a text input in a property line
     * @param props - BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps and InputProps
     * @returns property-line wrapped input component
     */
    export var TextInputPropertyLine: React.FunctionComponent<BABYLON.GuiEditor.SharedUIComponents.TextInputProps & BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps<string>>;
    export type NumberInputPropertyLineProps = BABYLON.GuiEditor.SharedUIComponents.SpinButtonProps & BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps<number>;
    /**
     * Wraps a number input in a property line
     * To force integer values, use forceInt param (this is distinct from the 'step' param, which will still allow submitting an integer value. forceInt will not)
     * @param props - BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps and InputProps
...
declare module BABYLON.GuiEditor.SharedUIComponents {
     ...
     * @returns property-line wrapped textbox that converts to/from hex number representation
     */
    export var HexPropertyLine: React.FunctionComponent<BABYLON.GuiEditor.SharedUIComponents.NumberInputPropertyLineProps>;
...
declare module BABYLON.GuiEditor.SharedUIComponents {
        type DropdownPropertyLineProps<V extends BABYLON.GuiEditor.SharedUIComponents.AcceptedDropdownValue> = BABYLON.GuiEditor.SharedUIComponents.DropdownProps<V> & BABYLON.GuiEditor.SharedUIComponents.PropertyLineProps<V>;
    /**
     * Dropdown component for number values.
     */
