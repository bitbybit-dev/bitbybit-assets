...
declare module "babylonjs-node-editor/fluent/icons" {




}
declare module "babylonjs-node-editor/fluent/primitives/utils" {
...
declare module "babylonjs-node-editor/fluent/primitives/toggleButton" {
...
declare module "babylonjs-node-editor/fluent/primitives/textInput" {
import { FunctionComponent } from "react";
import { PrimitiveProps } from "babylonjs-node-editor/fluent/primitives/primitive";
...
import { InfoLabelParentProps } from "babylonjs-node-editor/fluent/primitives/infoLabel";
...
declare module "babylonjs-node-editor/fluent/primitives/infoLabel" {
import { FunctionComponent } from "react";
...
declare module "babylonjs-node-editor/fluent/primitives/collapse" {
import { FunctionComponent, PropsWithChildren } from "react";
type CollapseProps = {
    visible: boolean;
...
import { BasePrimitiveProps } from "babylonjs-node-editor/fluent/primitives/primitive";
...
import { LinkProps } from "babylonjs-node-editor/fluent/primitives/link";
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLines/propertyLine";
import { FunctionComponent } from "react";
/**
...
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLines/propertyLine";
import { FunctionComponent } from "react";
import { TextInputProps } from "babylonjs-node-editor/fluent/primitives/textInput";
import { SpinButtonProps } from "babylonjs-node-editor/fluent/primitives/spinButton";
/**
...
import { FunctionComponent } from "react";
import { NumberInputPropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLines/inputPropertyLine";
/**
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type ToggleButtonProps = Omit<BABYLON.NodeEditor.SharedUIComponents.ButtonProps, "icon" | "onClick"> & {
        value: boolean;
        checkedIcon: any;
        uncheckedIcon?: any;
        onChange: (checked: boolean) => void;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type TextInputProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<string> & {
        validator?: (value: string) => boolean;
    };
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    export type ImmutablePrimitiveProps<ValueT> = BasePrimitiveProps & {
         ...
         * Optional information to display as an infoLabel popup aside the component.
         */
        infoLabel?: BABYLON.NodeEditor.SharedUIComponents.InfoLabelParentProps;
    };
    export type PrimitiveProps<T> = ImmutablePrimitiveProps<T> & {
        /**
         * Called when the primitive value changes
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type LinkProps = BABYLON.NodeEditor.SharedUIComponents.ImmutablePrimitiveProps<string> & {
        /**
         * Used if you want to handle the link click yourself
         */
        onLink?: () => void;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    type HsvKey = "h" | "s" | "v";
    type InputHsvFieldProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<BABYLON.Color3 | BABYLON.Color4> & {
        hsvKey: HsvKey;
        max: number;
        scale?: number;
    };
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type ButtonProps = BABYLON.NodeEditor.SharedUIComponents.BasePrimitiveProps & {
        onClick: () => void;
        icon?: any;
        appearance?: "subtle" | "transparent";
        label?: string;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type FileUploadLineProps = Omit<BABYLON.NodeEditor.SharedUIComponents.ButtonProps, "onClick" | "label"> & {
        onClick: (files: FileList) => void;
        label: string;
        accept: string;
    };
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type ButtonLineProps = Omit<BABYLON.NodeEditor.SharedUIComponents.ButtonProps, "label"> & {
        label: string;
    };
    /**
     * Wraps a button with a label in a line container
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        /**
     * Wraps a link in a property line
     * @param props - BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps and BABYLON.NodeEditor.SharedUIComponents.LinkProps
     * @returns property-line wrapped link
     */
    export var LinkPropertyLine: React.FunctionComponent<BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps<string> & BABYLON.NodeEditor.SharedUIComponents.LinkProps>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        /**
     * Wraps a text input in a property line
     * @param props - BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps and InputProps
     * @returns property-line wrapped input component
     */
    export var TextInputPropertyLine: React.FunctionComponent<BABYLON.NodeEditor.SharedUIComponents.TextInputProps & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps<string>>;
    export type NumberInputPropertyLineProps = BABYLON.NodeEditor.SharedUIComponents.SpinButtonProps & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps<number>;
    /**
     * Wraps a number input in a property line
     * To force integer values, use forceInt param (this is distinct from the 'step' param, which will still allow submitting an integer value. forceInt will not)
     * @param props - BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps and InputProps
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @returns property-line wrapped textbox that converts to/from hex number representation
     */
    export var HexPropertyLine: React.FunctionComponent<BABYLON.NodeEditor.SharedUIComponents.NumberInputPropertyLineProps>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type DropdownPropertyLineProps<V extends BABYLON.NodeEditor.SharedUIComponents.AcceptedDropdownValue> = BABYLON.NodeEditor.SharedUIComponents.DropdownProps<V> & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps<V>;
    /**
     * Dropdown component for number values.
     */
