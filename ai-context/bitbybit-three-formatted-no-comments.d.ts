declare namespace Bit {
    declare namespace Inputs {
        ...
        declare namespace ThreeJSCamera {
        ...
        declare namespace ThreeJSScene {
    ...
    type DrawnEntity = THREEJS.Group | Inputs.Draw.DrawnTag | Inputs.Draw.DrawnTags | undefined;
    declare class Draw extends DrawCore {
        ...
        drawAnyAsync(inputs: Inputs.Draw.DrawAny<THREEJS.Group>): Promise<DrawnEntity>;
    ...
    declare class ThreeJSCamera {
        private readonly context;
        orbitCamera: ThreeJSOrbitCamera;
    }
    type;
    {
        OrbitCameraInstance, InputHandler, OrbitCameraController;
    }
    ;
    declare class ThreeJSOrbitCamera {
        private readonly context;
    ...
    declare function createOrbitCamera(inputs: Inputs.ThreeJSCamera.OrbitCameraDto & {
        scene: THREEJS.Scene;
        domElement?: HTMLElement;
    }): OrbitCameraController;
    declare function initThreeJS(inputs?: ThreeJSScene.InitThreeJSDto): InitThreeJSResult;
    ...
    declare class PyramidSimple {
        ...
        drawModel(inputs: Advanced.Patterns.FacePatterns.PyramidSimple.PyramidSimpleData<Inputs.OCCT.TopoDSShapePointer>): Promise<Group>;
    ...
    declare class Text3D {
        ...
        drawModel(inputs: Advanced.Text3D.Text3DData<Inputs.OCCT.TopoDSShapePointer>, precision?: number): Promise<Group>;
