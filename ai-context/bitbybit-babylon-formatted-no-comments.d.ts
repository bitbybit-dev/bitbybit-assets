declare namespace Bit {
    declare namespace Inputs {
        ...
        declare namespace BabylonDecal {
    ...
    declare class BabylonGltf {
        private readonly context;
        loadAssetContainerFromUrl(inputs: Inputs.Asset.AssetFileByUrlDto): Promise<BABYLON.AssetContainer>;
        loadAssetContainer(inputs: Inputs.Asset.AssetFileDto): Promise<BABYLON.AssetContainer>;
    ...
    declare class BabylonIO {
        ...
        loadGlbFromArrayBuffer(inputs: Inputs.Asset.AssetGlbDataDto): Promise<BABYLON.Mesh>;
    ...
    declare class Navigation {
        ...
        flyTo(inputs: Advanced.Navigation.FlyToDto): void;
    ...
    declare class MaterialsService {
        ...
        static simpleBlackMaterial(scene: BABYLON.Scene): BABYLON.PBRMaterial;
