declare namespace Bit {
    declare namespace Inputs {
        ...
        declare namespace Draw {
            ...
            interface BitByBitEntity extends pc.Entity {
                bitbybitMeta?: BitByBitMeta | undefined;
            }
            interface DrawnTag extends Inputs.Tag.TagDto {
                bitbybitMeta?: BitByBitMeta | undefined;
            }
        ...
        declare namespace PlayCanvasCamera {
            class OrbitCameraDto {
                constructor(distance?: number, pitch?: number, yaw?: number, distanceMin?: number, distanceMax?: number, pitchAngleMin?: number, pitchAngleMax?: number, orbitSensitivity?: number, distanceSensitivity?: number, inertiaFactor?: number, autoRender?: boolean, frameOnStart?: boolean);
        ...
        interface PlayCanvasOrbitCameraInstance {
            autoRender: boolean;
            distanceMax: number;
            distanceMin: number;
            pitchAngleMax: number;
        ...
        interface PlayCanvasInputHandler {
            destroy(): void;
        }
        interface PlayCanvasOrbitCameraController {
        ...
        interface InitPlayCanvasResult {
            app: pc.Application;
            scene: pc.Entity;
        ...
        declare namespace PlayCanvasScene {
            class InitPlayCanvasDto {
                constructor(canvasId?: string, sceneSize?: number, backgroundColor?: string, enableShadows?: boolean, enableGround?: boolean, groundCenter?: Base.Point3, groundScaleFactor?: number, groundColor?: string, groundOpacity?: number, ambientLightColor?: string, ambientLightIntensity?: number, directionalLightColor?: string, directionalLightIntensity?: number, shadowMapSize?: number);
    ...
    declare namespace Advanced {
        ...
        declare namespace Navigation {
            ...
            declare class PointOfInterestStyleDto {
                ...
                pulseMinSize?: number | undefined;
                pulseMaxSize?: number | undefined;
                pulseThickness?: number | undefined;
    ...
    declare class ManifoldCrossSection {
        private readonly manifoldWorkerManager;
        readonly shapes: CrossSectionShapes;
        readonly operations: CrossSectionOperations;
        readonly booleans: CrossSectionBooleans;
        readonly transforms: CrossSectionTransforms;
        readonly evaluate: CrossSectionEvaluate;
    ...
    declare class PlayCanvasCamera {
        private readonly context;
        orbitCamera: PlayCanvasOrbitCamera;
    }
    ...
    declare class PlayCanvasOrbitCamera {
        private readonly context;
    ...
    declare function initPlayCanvas(inputs?: PlayCanvasScene.InitPlayCanvasDto): InitPlayCanvasResult;
    declare class PlayCanvas {
        private readonly context;
    ...
    declare class PyramidSimple {
        ...
        drawModel(inputs: Advanced.Patterns.FacePatterns.PyramidSimple.PyramidSimpleData<Inputs.OCCT.TopoDSShapePointer>): Promise<Inputs.Draw.BitByBitEntity>;
    ...
    declare class Text3D {
        ...
        drawModel(inputs: Advanced.Text3D.Text3DData<Inputs.OCCT.TopoDSShapePointer>, precision?: number): Promise<Inputs.Draw.BitByBitEntity>;
    ...
    declare class ShapeParser {
        static parse<TResult>(obj: unknown, partShapes: Models.OCCT.ShapeWithId<Inputs.OCCT.TopoDSShapePointer>[]): TResult;
    }
    declare class BitByBitBase {
        readonly draw: Draw;
        readonly playcanvas: PlayCanvas;
